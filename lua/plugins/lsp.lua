return {
	...
	dependencies = {
		...
		-- - Installsided by nvim-cmp
		{ "hrsh7th/cmp-nvim-lsp" }, -- LSPs, linters, formatters, etc. by their Mason package name.
	...
	config = function()
		...
		local servers = {
			...
			omnisharp = {
				cmd = { "omnisharp" }, -- or Mason path if needed
				enable_roslyn_analyzers = true,
				organize_imports_on_format = true,
				enable_import_completion = true,
			},
			-- html = { filetypes = { 'html', 'twig', 'hbs' } },
			cssls = { filetypes = { "css", "qss" } },
			-- dockerls = {},
			-- sqlls = {},
			-- jsonls = {},
			-- yamlls = {},
